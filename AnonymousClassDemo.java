//Code Listing 10-43 (AnonymousClassDemo.java)
...
// Create an object that implements IntCalculator. IntCalculator square = new IntCalculator() {
public int calculate(int number) {
return number * number; }};
// Get a number from the user. System.out.print("Enter an integer number: "); 
